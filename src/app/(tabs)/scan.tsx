    ...
    <Screen
      header={
        <FadeInView>
          <AppHeader
            title="Select Shift"
            subtitle="Choose a shift to start scanning"
            large
          />
        </FadeInView>
      }
      ...
      <View style={styles.sectionHeader}>
        <View>
          ...
          <Text style={styles.sectionSubtitle}>
            Tap a shift to open the scanner
          </Text>
        </View>
        ...
        <View style={styles.infoCard}>
          ...
          <View style={styles.infoContent}>
            ...
            <Text style={styles.infoText}>
              Tap a shift to open the scanner
              immediately. You can change the
              shift directly from the scanner.
            </Text>
          </View>
        </View>
      </FadeInView>
